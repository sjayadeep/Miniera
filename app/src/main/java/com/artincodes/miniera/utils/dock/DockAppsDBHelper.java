 ...
 */
public class DockAppsDBHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "DockApps.db";
    public static final String TABLE_NAME = "Apps";
    public static final String COLUMN_INDEX= "grid_index";
    public static final String COLUMN_PACKAGE = "package";
    public static final String COLUMN_NAME = "name";
    Context mContext;
    String TAG = "DOCK APPS DB";

    public DockAppsDBHelper(Context context) {
    ...
    public boolean insertApp  (int index, String packageName,String name)
    {
        ...
        Cursor cursor = db.rawQuery("select * from " + TABLE_NAME + " where " + COLUMN_INDEX +" = " + index, null);
